...
const Form = () => {
        ...
        <body>
          ...
          <script>
            window.onload = () => {
              ...
              }, 500); // slight delay ensures fonts/icons load
            };
          </script>
        </body>
      </html>
  ...
  return (
    <div>
      ...
      {submitted && (
        <div className="d-flex justify-content-center my-3 no-print">
          <button className="fancy-button " onClick={handlePrintSummary}>
